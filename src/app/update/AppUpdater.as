package app.update
{
	...
	public class AppUpdater extends EventDispatcher
	{
		...
		public function AppUpdater(app:Application, appCfg:AppConfig)
		{
			...
			loader.addEventListener(IOErrorEvent.IO_ERROR, function(event:Event):void{trace(event);});
		...
		public function checkUpdate(url:String, auto:Boolean=true):void
		{
			this.auto = auto;
			this.loader.load(new URLRequest(url + "/AppConfig.xml"));
		}
